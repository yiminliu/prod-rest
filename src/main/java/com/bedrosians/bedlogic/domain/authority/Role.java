...
public enum Role {
	...
	*/
	...
	public static Role[] getInternalRoles() {
		return new Role[] { ROLE_SUPERUSER, ROLE_ADMIN, ROLE_MANAGER, ROLE_SALES };
	}
	...
	public static String[] getInternalRolesAsString() {
		return new String[] { ROLE_SUPERUSER.toString(), ROLE_ADMIN.toString(), ROLE_MANAGER.toString(), ROLE_SALES.toString() };
	}
