...
public class ProductNewFeature implements java.io.Serializable {
	...
	public ProductNewFeature() {
	}
	
	public ProductNewFeature(String itemCode) {
		this.itemCode = itemCode;
	}
	
	public ProductNewFeature(String itemCode, Grade grade, Status status,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProductNewFeature other = (ProductNewFeature) obj;
		if (itemCode == null) {
