...
import com.bedrosians.bedlogic.domain.product.embeddable.Cost;
import com.bedrosians.bedlogic.domain.product.embeddable.Description;
import com.bedrosians.bedlogic.domain.product.embeddable.Dimensions;
import com.bedrosians.bedlogic.domain.product.embeddable.Material;
...
import com.bedrosians.bedlogic.domain.product.embeddable.Purchasers;
import com.bedrosians.bedlogic.domain.product.embeddable.Series;
import com.bedrosians.bedlogic.domain.product.embeddable.SimilarItemCode;
import com.bedrosians.bedlogic.domain.product.embeddable.TestSpecification;
...
public class Product implements java.io.Serializable {
	...
	//------- Associations --------//
  	private List<ProductVendor> newVendorSystem = new ArrayList<>();
  	private ProductNewFeature productNewFeature;
	...
	@Cache(usage=CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
	@IndexedEmbedded
	public ProductNewFeature getProductNewFeature() {	
	    return this.productNewFeature;
	}
	public void setProductNewFeature(ProductNewFeature productNewFeature) {
		this.productNewFeature = productNewFeature;
	}
	
	public void addProductNewFeature(ProductNewFeature productNewFeature ){
		if(this.getProductNewFeature() != null)
			setProductNewFeature(null);
		productNewFeature.setProduct(this);
		this.productNewFeature = productNewFeature;
	}
	...
	public List<ProductVendor> getNewVendorSystem() {
		return this.newVendorSystem;
	}
	public void setNewVendorSystem(List<ProductVendor> newVendorSystem) {
		this.newVendorSystem = newVendorSystem;
	}

	public void addNewVendorSystem(ProductVendor vendor){
		if(vendor.getProductVendorId().getItemCode() == null)
		   vendor.getProductVendorId().setItemCode(this.getItemcode());	
		vendor.setProduct(this);
		if(getNewVendorSystem() == null)
		   setNewVendorSystem(new ArrayList<ProductVendor>());	
	...
	public void initVendors(int numberOfVendors){
		for(int i = 0; i < numberOfVendors; i++) {
			addNewVendorSystem(new ProductVendor());
		}
	}
	...
	*/
	...
	public Product(String itemcode, String itemcategory, String countryorigin,
			...
			List<ProductVendor> newVendorSystem, ProductNewFeature productNewFeature,
	...
	public String toString() {
		return "Product "
				+ "[itemcd=" + itemcode 
				+ ", productNewFeature=" + productNewFeature 
				+ ", abccode=" + abccode 
