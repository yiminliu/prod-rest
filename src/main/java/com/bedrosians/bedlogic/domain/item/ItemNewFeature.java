...
public class ItemNewFeature implements java.io.Serializable {
	...
	public ItemNewFeature() {
	}
	
	public ItemNewFeature(String itemCode) {
		this.itemCode = itemCode;
	}
	
	public ItemNewFeature(String itemCode, Grade grade, Status status,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ItemNewFeature other = (ItemNewFeature) obj;
		if (itemCode == null) {
