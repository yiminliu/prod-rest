...
<table>
   <div class="container" style="color:GREEN"> <h3>General Information</h3></div>
    ...
    <tr>
        ...
        <!--<td>Active Status: <form:input path="inactivecode"></form:input></td>-->
       ...
       <td><label for="inactivecodeOptions">Shade Variation: </label>
       ...
       <td><label for="statusOptions">Status: </label>
            <form:select id="status" path="newFeature.status" cssClass="span-8" cssErrorClass="span-8 validationFailed" cssStyle="width:280px;">
               <form:option value="0" selected="selected">Select one</form:option>
               <c:forEach var="status" items="${statusList}" varStatus="status">
                 <form:option value="${mps}">${status}</form:option>
              </c:forEach>
           </form:select>
       </td>
    ...
    <table>
     <tr>
        ...
        <!-- <td>Special Price Unit: <form:input path="price.tempprice"></form:input></td>-->
        <td>Special Price Start Date: <form:input path="price.tempdatefrom"></form:input></td>
        <td>Special Price End Date: <form:input path="price.tempdatethru"></form:input></td>
     </tr>     
    </table>   
    ...
    <table>
     <c:forEach items="${newVendorSystem}" var="vendor" varStatus="loop">
       <tr>
          <td>Vendor Order: <form:input path="vendor.vendorOrder"></form:input></td>  
          ...
          <td>Vendor Price Unit: <form:input path="newVendorSystem.[${loop.index}].vendorPriceUnit"></form:input></td>
    ...
    <!--<td><fmt:formatDate value="${item.price.tempdatefrom}" pattern="hh:mma MMM d, yyyy" /></td>
                             <td><fmt:formatDate value="${item.price.tempdatethru}" pattern="hh:mma MMM d, yyyy" /></td>-->
